...
public class Cliente {
	    ...
	    public Cliente(int identificacao, String nome, String logradouro, int numero, String bairro, 
	    			   String municipio, String estado, String cep, String telefone, String cpf ) {
